    ...
    return (
        <div className="h-full flex flex-col min-h-0">
            ...
            <div className="px-3 py-2.5 border-b border-white/10 bg-black/40 flex items-center justify-between gap-2">
                <button
                    onClick={onBack}
                    className="text-white/80 hover:text-white flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-xl bg-white/10 hover:bg-white/20 border border-white/10 transition-all cursor-pointer shadow-sm active:scale-95 shrink-0"
                >
                ...
                <button onClick={() => { game.endGame(); onBack(); }} className="text-xs text-red-400 hover:text-red-300 font-semibold shrink-0 px-2 py-1 rounded-lg bg-red-500/10 hover:bg-red-500/20 transition-all cursor-pointer">End Game</button>
            </div>
